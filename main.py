...
print(word.lower())
print(word.upper())
print(word.replace("name", "friend"))
print(word[3:7])
...
obj1= input("What is an object in the room?")
obj2= input("What is an object in the room?")
obj3= input("What is an object in the room?")
print(f" 3 objects in the room are {obj1} , {obj2} , {obj3}")
...
print(f"My favorite movie is {color}")
print(f"Hello {name} , you are {age} years old and your favorite color is {movie}")
